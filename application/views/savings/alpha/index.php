  ...
  <div class="content-wrapper">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Total amount from Alpha Savings',
          colors: ["#b9c246"],
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alpha Savings Index</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php //endif; ?>
            ...
            <p style="color:orange">Total Cashflow - Deposits</p>
            <h4>₦20,000 - <a href="<?php echo base_url('savingsplans/alpha/alphaActivity');?>">View Activity</a></h4>

            </div><!--/single-info-card-->

            <div class="col-lg-3 col-md-3 col-sm-12 single-info-card">

            <p style="color:orange">Total Cashflow - 30 Days (Deposits)</p>
            <h4> ₦12,000</h4>
...
<p style="color:orange">Withdrawals</p>
<h4>₦3,000 - <a href="<?php echo base_url('savingsplans/alpha/alphaWithdrawals');?>">View Activity</a></h4>

</div><!--/single-info-card-->

<div class="col-lg-3 col-md-3 col-sm-12 single-info-card">

<p style="color:brown">Plan Upgrades</p>
<h4>6</h4>
...
<div class="col-lg-3 col-md-3 col-sm-12 single-info-card">
<p style="color:red">Suspended Accounts </p>
<h4> 1 </h4>
