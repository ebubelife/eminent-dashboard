  ...
  <div class="content-wrapper">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Chart - Alpha Savings (9 months plan)',
          colors: ["#b9c246"],
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alpha Savings</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Alpha</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createUser', $user_permission)): ?>
            ...
            <a href="<?php echo base_url('members/manage/ufuma') ?>" class="btn btn-default">Alpha 1 Month</a>
            <a href="<?php echo base_url('members/manage/asaba') ?>" class="btn btn-default">Alpha 3 Months</a>
            <a href="<?php echo base_url('members/manage') ?>" class="btn btn-default">Alpha 6 Month</a>
            <a href="<?php echo base_url('members/manage') ?>" class="btn btn-default">Alpha 9 Month</a>
            <a href="<?php echo base_url('members/manage') ?>" class="btn btn-default">Alpha 12 Month</a>
